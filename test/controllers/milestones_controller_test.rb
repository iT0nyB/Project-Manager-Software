...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { completionDate: @milestone.completionDate, name: @milestone.name, startDate: @milestone.startDate, state: @milestone.state }
    end
  ...
  test "should update milestone" do
    patch :update, id: @milestone, milestone: { completionDate: @milestone.completionDate, name: @milestone.name, startDate: @milestone.startDate, state: @milestone.state }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
